...
import com.duong.response.ApiResponse;
import com.duong.service.PostService;
...
public class PostController {
	...
	public ResponseEntity<List<Post>> findUserPostHandle(@PathVariable Integer userId){
	...
	public ResponseEntity<List<Post>> findAllPostHandle(){
	...
	public ResponseEntity<Post> savedPostHandle(@PathVariable Integer postId,@RequestHeader("Authorization") String jwt) throws Exception{
	...
	public ResponseEntity<Post> likePostHandle(@PathVariable Integer postId,@RequestHeader("Authorization") String jwt) throws Exception{
		User reqUser=userService.findUserByJwt(jwt);
